...
namespace Hospital.View
{
    ...
    public partial class CreatePatientAppointment : Window, INotifyPropertyChanged
    {
        ...
        {
            SearchDoctors searchDoctors = new SearchDoctors(_doctorController);
            searchDoctors.ShowDialog();
            if (searchDoctors.SelectedDoctor != null)
            {
                Appointment.IdDoctor = searchDoctors.SelectedDoctor.Id;
            }
        }
